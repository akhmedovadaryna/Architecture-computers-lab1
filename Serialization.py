...
class Serialization:
    ...
    def save_to_pickle(self, obj):
        with open(self.file_name + '.pickle', 'wb') as file:
            pickle.dump(obj, file)

    def load_from_pickle(self):
        with open(self.file_name + '.pickle', 'rb') as file:
            list_with_dict = pickle.load(file)
        return list_with_dict

    def save_to_yaml(self, obj):
        with open(self.file_name + ".YAML", "w") as file:
            yaml.dump(obj, file)

    def load_from_yaml(self):
        with open(self.file_name + ".YAML", "r") as file:
